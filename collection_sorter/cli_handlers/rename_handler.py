...
class RenameCommandHandler(TemplateMethodCommandHandler):
    ...
    def pre_process(self, 
                   ...
                   destination_path: Optional[FilePath]) -> Result[None, OperationError]:
    ...
    def process_sources(self, 
                       source_paths: List[FilePath], 
                       destination_path: Optional[FilePath]) -> Result[Dict[str, Any], List[OperationError]]:
...
class RenameCommandHandlerAlternative(FactoryBasedCommandHandler):
    ...
    @classmethod
    def from_click_context(cls, ctx: click.Context) -> "RenameCommandHandlerAlternative":
        """Create a handler from a Click context.
