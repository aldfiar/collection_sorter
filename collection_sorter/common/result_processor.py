...
class ResultFileProcessor:
    ...
    def list_files(self, path: Union[str, Path, FilePath]) -> Result[List[Path], OperationError]:
        """
    ...
    def list_directories(self, path: Union[str, Path, FilePath]) -> Result[List[Path], OperationError]:
        """
