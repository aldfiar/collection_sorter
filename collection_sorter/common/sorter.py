...
class MultiThreadTask:
    ...
    def execute(self, source: BaseCollection, destination: Optional[Path] = None) -> None:
...
class SortExecutor:
    ...
    def sort(self, collection: CollectionPath, destination: Optional[Path] = None, 
            task: Optional[MultiThreadTask] = None) -> None:
