...
from .paths import DirectoryPath, FilePath
...
class FileProcessor:
    ...
    def process_collection(
        self, source: Union[str, Path, FilePath], operation: Callable, *args, **kwargs
    ) -> List[Any]:
        """
    ...
    def bulk_move(
        ...
        return self.process_collection(
            source, self.move_file, destination, continue_on_error=continue_on_error
        )
    ...
    def bulk_copy(
        ...
        """
        return self.process_collection(
            source, self.copy_file, destination, continue_on_error=continue_on_error
        )
